  ...
  return (
    <div className={`mx-auto ${className}`} style={{ maxWidth: '85%' }}>
      <div className="relative overflow-hidden rounded-2xl aspect-[1.586/1] bg-gradient-to-br from-emerald-500 via-emerald-600 to-emerald-800 flex flex-col justify-between p-5 shadow-lg">
        ...
        >
          <defs>
            <pattern id="card-bg-2" x="0" y="0" width="55" height="55" patternUnits="userSpaceOnUse">
          ...
          <rect width="100%" height="100%" fill="url(#card-bg-2)" />
        ...
        {/* Top: EMV chip — moved right+down, enlarged 25% */}
        <div className="relative z-10 ml-3 mt-3">
        ...
        {/* Bottom: balance — shifted right, smaller main, larger decimals */}
        <div className="relative z-10 pb-1 ml-2">
          <p className="text-[10px] font-medium mb-1.5 uppercase tracking-[0.22em] text-[#FDFCF8]/55">{label}</p>
          <div className="flex items-start">
            <span className="text-[25px] md:text-[29px] font-bold tracking-tighter leading-none text-[#FDFCF8]">{prefix}</span>
            <span className="w-[0.15em] flex-shrink-0" />
            <span className="text-[25px] md:text-[29px] font-bold tracking-tighter leading-none text-[#FDFCF8]">{integer}</span>
            <span className="text-[15px] font-semibold ml-0.5 mt-1.5 leading-none text-[#FDFCF8]">.{decimal}</span>
          </div>
        </div>
      </div>
    </div>
