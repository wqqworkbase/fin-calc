...
export default function SiteLogo() {
  return (
    <Link href="/" className="flex items-center gap-1.5 select-none">
      ...
      <svg viewBox="0 0 32 40" className="w-6 h-7 flex-shrink-0" xmlns="http://www.w3.org/2000/svg">
        <defs>
      ...
      <div className="flex flex-col leading-tight">
        <span className="text-[18px] font-black text-gray-900 tracking-tight leading-none">Calculator</span>
